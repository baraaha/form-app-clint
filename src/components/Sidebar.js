      ...
      <div className="sidebar">
        <nav className="mt-2">
          ...
          >
              ...
              <ul className="nav nav-treeview">
                ...
                <li className="nav-item">
                  <Link to="categories" className="nav-link">
                    <i className="far fa-circle nav-icon"></i>
                    <p>التصنيفات (تصنيفات فرعية)</p>
                  </Link>
                </li>
                <li className="nav-item">
                  <Link to="prodects" className="nav-link">
                    <i className="far fa-circle nav-icon"></i>
                    <p>المنتجات</p>
                  </Link>
                </li>
            ...
            <li className="nav-item">
              <p className="nav-link">
                <svg focusable="false" class="" data-icon="wallet" width="1em" height="1em" fill="currentColor" aria-hidden="true" viewBox="64 64 896 896"><path d="M880 112H144c-17.7 0-32 14.3-32 32v736c0 17.7 14.3 32 32 32h736c17.7 0 32-14.3 32-32V144c0-17.7-14.3-32-32-32zm-40 464H528V448h312v128zm0 264H184V184h656v200H496c-17.7 0-32 14.3-32 32v192c0 17.7 14.3 32 32 32h344v200zM580 512a40 40 0 1080 0 40 40 0 10-80 0z"></path></svg>
                <p>
                  المصروفات
                  <i className="right fas fa-angle-left"></i>
                </p>
              ...
              <ul className="nav nav-treeview">
                <li className="nav-item">
                  <Link to="expense-categories" className="nav-link">
                    <i className="far fa-circle nav-icon"></i>
                    <p>فئات الصرف</p>
                  </Link>
                </li>
            ...
            <li className="nav-item">
              <Link to="seeting" className="nav-link">
                <svg
                  focusable="false"
                  className=""
                  data-icon="setting"
